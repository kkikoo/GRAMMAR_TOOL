# double_Terminal_symbol.py
# We defined a class called DoubleTerminal, a test doubles of class Terminal

# DoubleOption is as same as Option, except their name.
...
class DoubleTerminal:
    ...
    def __eq__(self, __o) -> bool:
        ...
        elif isinstance(__o, DoubleTerminal):
